...
<body>
    ...
    <section class="home" id="home">
            ...
            <p> We are final year students Of B.Tech Computer Science <br> and doing our internship at XYZ.</p>
            <div class="button">
    ...
    <section class="services" id="services">
        ...
        <div class="services-content">
            <div class="box">
                ...
                <p>We are currently designing our demo project for XYZ as project trainee. Apart from demo project we have done various academic projects. </p>
    ...
    <section class="contact" id="contact">
        <div class="contact-text">
            ...
            <div class="list">
            <ul>
            	<li><a href="#"></a>956443xxxx</li>
                <li><a href="#"></a>995634xxxx</li>
                <li><a href="#"></a>a@gmail.com</li>
                <li><a href="#"></a>a@gmail.com</li></ul>
